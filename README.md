# Bitstamp API .NET [![Build status](https://ci.appveyor.com/api/projects/status/vqnr7rbjt87lgkg7?svg=true)](https://ci.appveyor.com/project/JoJatekok/bitstampapi-net)
